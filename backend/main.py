...
st.markdown("Upload your resuke and get AI feedback")
...
if analyse and uploaded_file:
    try:
        ...
        Please provide you analysis in a clear, structured format with specific recommendations
        """
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are an expert resume reviwer with years of experience",
                },
