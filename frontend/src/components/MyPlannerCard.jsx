        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-7">
          <div className="max-w-xl">
            ...
            <p className="mt-2 text-sm font-normal text-slate-600 dark:text-slate-400">
              Explore any UNSW degree and get a personalised roadmap tailored to your goals and career direction.
            </p>
          ...
          <div className="shrink-0 lg:w-80">
            <div className="rounded-2xl border border-slate-200/60 backdrop-blur-sm p-5 shadow-lg">
              <div className="h-36 rounded-xl bg-gradient-to-b dark:bg-gray-900 relative overflow-hidden">
