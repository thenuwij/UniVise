  ...
  return (
    <div className="card-glass-spotlight w-2/5 py-2.5">
      ...
      <div className="relative p-4 md:p-7 flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="mt-4">
            <Button onClick={() => navigate("/chat")} pill className="button-primary">
              <HiChatBubbleLeftRight className="mr-2 h-4 w-4" />
              Chat with Eunice
            </Button>
          </div>
        ...
        {/* Right column — decorative layered icon */}
        <div className="flex-shrink-0 flex items-center justify-center w-28 h-28 relative">
          <HiChatBubbleLeftRight className="absolute h-24 w-24 text-slate-400 dark:text-slate-500 opacity-10" />
          <HiChatBubbleLeftRight className="relative h-12 w-12 text-indigo-500 dark:text-sky-400 opacity-60" />
        </div>
      </div>
    </div>
  );
